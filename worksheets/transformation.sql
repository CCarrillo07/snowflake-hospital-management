...
DESCRIBE TABLE harmonized.patients;
...
2. Amount: Clean and standardize values, then convert to a NUMBER data type.
...
SELECT
    ...
    CASE
        WHEN LOWER(REPLACE(payment_method, ' ', '')) = 'insurance' THEN 'Insurance'
        WHEN LOWER(REPLACE(payment_method, ' ', '')) = 'creditcard' THEN 'Credit Card'
